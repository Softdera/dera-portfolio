      ...
      <p>    A Software Engineer with strong background in developing code based and no/low code software products/applications. 
        ...
        <ul> 
            <li>
                ...
                <p>Process Automation: Handled the automation of the HDA Milestone 3 process, developed from scratch the step by step automated process for scoring/validating the Milestone 3 submission for the Graduate Fellowship Grant. Leveraged on AI tools such as Active Pieces to handle the automation flow, Paper Forms, Custom Code, Ollama3, Straico AI, and more. Developed a Custom Prompt for evaluating dynamically the Milestone submitted by the HDA Fellows against a predefined methodology and criterias. Developed a Custom Prompt that carries out these evaluation with an accuracy rate of over 95%. Thus, easing the process for the HDA Committee. </p>
              </li>
            <li>
                <h3>VoteDeck</h3>
                <h4 style="color: white;">Frontend Engineer</h4>
                <h5>2024 - Present</h5>  
